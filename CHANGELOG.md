# Ultras Lutetia — Historique du Service Worker

Historique complet des changements de `sw.js`, déplacé ici le 07/07/2026
pour ne pas alourdir le fichier livré à chaque déploiement.
